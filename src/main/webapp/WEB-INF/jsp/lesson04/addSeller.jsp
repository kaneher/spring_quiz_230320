	...
	<div class="container">
		...
		<form method="post" action="/lesson04/quiz01/add_seller">
			...
			<div class="form-group">
				...
				<input type="text" id="profileImageUrl" name="profileImageUrl" class="form-control col-8" placeholder="프로필 사진 URL을 입력해주세요">
			</div>
			<div class="form-group">
				<label for="temperature"><b>온도</b></label>
				<input type="text" id="temperature" name="temperature" class="form-control col-3" placeholder="온도를 입력해주세요">
			</div>
